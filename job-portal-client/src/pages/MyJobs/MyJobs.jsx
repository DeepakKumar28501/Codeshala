...
const Myjobs = () => {
  const email = "kanoujiya28501@gmail.com";
  ...
  useEffect(() => {
    setIsLoading(true);
    fetch(`http://localhost:5000/myjob/kanoujiya28501@gmail.com`)
      .then((res) => res.json())
      .then((data) => {
        setJobs(data);
        setIsLoading(false);
    ...
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4 mt-10">
      ...
      <div className="my-jobs-container">
        ...
        <div className="search-box p-2 text-center mb-2">
          ...
          />
          <button
            className="bg-orange text-white font-semibold px-8 py-2 rounded-sm mb-4"
      ...
      <section className="py-1 bg-blueGray-50">
        ...
        {/* pagination  */}
        <div className="flex justify-center items-center text-black space-x-8 mb-8">
          {currentPage > 1 && (
